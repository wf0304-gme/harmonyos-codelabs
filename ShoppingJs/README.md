# ShoppingDemoJs
简介
• 本篇Codelab使用UI组件开发了一个购物应用。 应用包含两级页面，分别是主页和商品详情页，都展示了丰富的HarmonyOS UI组件。
...
What is it?
In this article, Codelab develops a shopping application using UI components. The application has two levels of pages: home page and offering details page, which display various HarmonyOS UI components.
