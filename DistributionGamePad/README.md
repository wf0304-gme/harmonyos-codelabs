...
What is it?
DistributionGamePad is a simple distribution flying game which contains tow application are GameApplication and GameHandle. It's to show distribution and graphic capability.
GameApplication:It's running in TV side is a plane game.
GameHandle:It's running in phone side is a handle which can control plane in TV side.
