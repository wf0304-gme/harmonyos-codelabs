...
简介
• 此Demo用于通用文字识别。 您可以对文档翻拍、街景翻拍等图片的文字进行检测和识别。
...
What is it?
This demo is used for general text recognition. You can detect and recognize text in images such as document remakes and streetscape remakes.
